...
if not(isempty(obj.F_pull_vec))  
    ...
    x_vec(1,:) = 0;
    dx = 1/NPoints*[obj.PleatedMembrane.xmin_th; 0.99*obj.PleatedMembrane.xmax_th];
    obj.NPoints = NPoints;
end

NominalConfigParametersPlM = [obj.PleatedMembrane.rc0,obj.PleatedMembrane.rc,obj.PleatedMembrane.phi_c,...
    obj.PleatedMembrane.phi_v,obj.PleatedMembrane.rs1,obj.PleatedMembrane.x0s1,...
    obj.PleatedMembrane.rs2,obj.PleatedMembrane.x0s2,obj.PleatedMembrane.vmax];

NominalConfigParametersBel = [obj.Bellows.alpha_s,obj.Bellows.h,obj.Bellows.rcs1,...
    obj.Bellows.Rs1,obj.Bellows.Rt1,obj.Bellows.h1,obj.Bellows.rcs2,obj.Bellows.Rs2,...
...
ConstantParametersPlM = [obj.PleatedMembrane.L,obj.PleatedMembrane.lc,...
obj.PleatedMembrane.lv,obj.PleatedMembrane.Roe,obj.PleatedMembrane.Rie,...
obj.PleatedMembrane.alpha,obj.PleatedMembrane.delta,obj.PleatedMembrane.gamma,...
...
Rcm = obj.PleatedMembrane.Rcm;
Rvm = obj.PleatedMembrane.Rvm;
...
if ElasticForceBool
    ...
    F_el_membr_vec = F_el_bell_vec; % TO DO: model stiffness of the pleated membrane
else
